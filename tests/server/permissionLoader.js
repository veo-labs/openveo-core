...
describe('permissionLoader', function() {
  ...
  before(function() {
    plugins = {
      example: {
        ...
        path: __dirname,
        entities: {
          entity: 'controllers/MyEntityController',
          contentEntity: 'controllers/MyContentController'
        }
      }
    };
  });
  ...
  describe('generateEntityPermissions', function() {
    ...
    it('should be able to generate permissions for entities for each plugin', function() {
