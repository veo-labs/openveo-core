...
describe('RoleController', function() {
  ...
  describe('removeRole', function() {
    ...
    it('Should be able to remove a role ', function(done) {
      ...
      $httpBackend.when('DELETE', '/be/roles/146574894654').respond(200);
      $httpBackend.expectDELETE('/be/roles/146574894654');
    ...
    it('Should be able to remove many roles ', function(done) {
      ...
      $httpBackend.when('GET', /.*/).respond(200, '');
      $httpBackend.when('PUT', /.*/).respond(200, '');
      $httpBackend.when('DELETE', '/be/roles/146574894654,146571234567').respond(200);
      $httpBackend.expectDELETE('/be/roles/146574894654,146571234567');
    ...
    it('Should logout user if a 401 is returned by the server', function(done) {
      ...
      $httpBackend.when('GET', /.*/).respond(200, '');
      $httpBackend.when('PUT', /.*/).respond(200, '');
      $httpBackend.when('DELETE', '/be/roles/146574894654').respond(401);
      $httpBackend.expectDELETE('/be/roles/146574894654');
  ...
  describe('saveRole', function() {
    ...
    it('Should be able to save a role if not already saving', function(done) {
      ...
      $httpBackend.when('GET', /.*/).respond(200, '');
      $httpBackend.when('PUT', /.*/).respond(200, '');
      $httpBackend.when('POST', '/be/roles/146574894654').respond(200);
      $httpBackend.expectPOST('/be/roles/146574894654');
    ...
    it('Should logout user if a 401 is returned by the server', function(done) {
      ...
      $httpBackend.when('GET', /.*/).respond(200, '');
      $httpBackend.when('PUT', /.*/).respond(200, '');
      $httpBackend.when('POST', '/be/roles/146574894654').respond(401);
      $httpBackend.expectPOST('/be/roles/146574894654');
  ...
  describe('addRole', function() {
    ...
    it('Should be able to add a new role', function(done) {
      ...
      $httpBackend.when('GET', /.*/).respond(200, '');
      $httpBackend.when('POST', /.*/).respond(200, '');
      $httpBackend.when('PUT', '/be/roles').respond(200);
    ...
    it('Should logout user if a 401 is returned by the server', function(done) {
      ...
      $httpBackend.when('GET', /.*/).respond(200, '');
      $httpBackend.when('POST', /.*/).respond(200, '');
      $httpBackend.when('PUT', '/be/roles').respond(401);
      $httpBackend.expectPUT('/be/roles');
