...
// The name of the videos collection
...
VideoProvider.prototype.add = function(videoPackage, callback){
  this.database.insert(VIDEOS_COLLECTION, {
    id : videoPackage.id, 
...
VideoProvider.prototype.getVideos = function(callback){
  this.database.get(VIDEOS_COLLECTION, null, null, -1, callback);
};
...
VideoProvider.prototype.getVideo = function(id, callback){
  this.database.get(VIDEOS_COLLECTION, {id : parseInt(id)}, null, 1, function(error, videos){
...
VideoProvider.prototype.removeVideo = function(id, callback){
  this.database.remove(VIDEOS_COLLECTION, {id : parseInt(id)}, callback);
};
...
VideoProvider.prototype.updateVideo = function(id, info, callback){
  this.database.update(VIDEOS_COLLECTION, {id : parseInt(id)}, info, callback);
};
...
VideoProvider.prototype.publishVideo = function(id, callback){
  this.database.update(VIDEOS_COLLECTION, {id : parseInt(id), state : VideoProvider.SENT_STATE}, {state : VideoProvider.PUBLISHED_STATE}, callback);
};
...
VideoProvider.prototype.unpublishVideo = function(id, callback){
  this.database.update(VIDEOS_COLLECTION, {id : parseInt(id), state : VideoProvider.PUBLISHED_STATE}, {state : VideoProvider.SENT_STATE}, callback);
};
  ...
  if(!this.pendingUpdateOperations){
    ...
    process.nextTick(function(){
      for(var videoId in self.pendingUpdateOperations){
        self.database.update(VIDEOS_COLLECTION, {
            id : parseInt(videoId)
...
function updateVideoProperties(id, properties, callback){
  if(properties && typeof properties === "object"){
    this.database.update(VIDEOS_COLLECTION, {
      id : id
